...
<body>
 <div class="container">
  <div class="row mt-3">
    ...
    <div class="col-12 col-md-3"><span class="material-symbols-outlined"style="color:#613818;font-weight:bold">person</span> <span style="color:#613818;font-weight:bold">Joel Lawa</span></div>
  ...
  <div class="row">
    ...
    <label> 
      ...
      <select name="selection">
        <option value="select">Envellope</option>
        <option value="AFG">Boite</option>
        <option value="ALA">Palette</option>
        <option value="ALB">Carton</option>
      </select>
    </label>
    <label>
      <span>Poids <span class="required">*</span></span>
      <input type="text" name="poids" style="width: 55px;" placeholder="0.5" required>
      ...
      <input type="text" name="quantité" style="width: 30px;" placeholder="02">
    </label>
    <label>
  ...
  <form action="" method="">
    <label>
      ...
      <input type="text" name="longueur"  placeholder="35"> cm
    </label>
    <label>
      <span class="lname">Largeur <span class="required">*</span></span>
      <input type="text" name="largeur"  placeholder="15"> cm
    </label>
    <label>
      <span class="lname">Hauteur <span class="required">*</span></span>
      <input type="text" name="largeur"  placeholder="20"> cm
    </label>
    </div>
  </div><br>
  <div class="section1">
  <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
  <label for="vehicle1"> <h5 style="color: #613818;">Protection contre les pertes et les dommages (Valeur déclarée)</h5> 
  Nous pouvons vous couvrir à hauteur de 50 CAD sans frais supplémentaire. </label><br>
  <input type="checkbox" id="vehicle2" name="vehicle2" value="Car">
  <label for="vehicle2"> Batteries au lithium incluses (+$)
Toutes les piles </label><br>
  <input type="checkbox" id="vehicle3" name="vehicle3" value="Boat">
  <label for="vehicle3">Options de signature (+$)
Vérifier la livraison de cet envoi.</label><br><br>
  </div>
  ...
  <g id="Groupe_1" data-name="Groupe 1" transform="translate(-342 -540)">
    <text id="_15" data-name="$15" transform="translate(349 594)" fill="#613818" font-size="50" font-family="Segoe UI Variable Text" font-weight="600"><tspan x="0" y="0">$<?= $_SESSION['cout_total_zone'][3] ?></tspan></text>
    ...
    <text id="Le_lendemain" data-name="Le
lendemain" transform="translate(387 624)" fill="#5c5d5e" font-size="18" font-family="Segoe UI Variable Text" font-weight="600"><tspan x="0" y="0">Le</tspan><tspan x="0" y="24">lendemain</tspan></text>
    </g>
    </svg>
   </div> 
   <div class="col-6 col-md-3">
  ...
  <g id="Groupe_2" data-name="Groupe 2" transform="translate(-503 -541)">
    <text id="_22" data-name="$22" transform="translate(527 595)" fill="#613818" font-size="50" font-family="Segoe UI Variable Text" font-weight="600"><tspan x="0" y="0">$<?= $_SESSION['cout_total_zone'][2] ?></tspan></text>
    ...
    <text id="En_apres-midi" data-name="En
apres-midi" transform="translate(551 624)" fill="#5c5d5e" font-size="18" font-family="Segoe UI Variable Text" font-weight="600"><tspan x="0" y="0">En</tspan><tspan x="0" y="24">apres-midi</tspan></text>
    </g>
    </svg>
   </div>
   <div class="col-6 col-md-3">
    ...
    <text id="_36" data-name="$36" transform="translate(699 596)" fill="#613818" font-size="50" font-family="Segoe UI Variable Text" font-weight="600"><tspan x="0" y="0">$<?= $_SESSION['cout_total_zone'][1]?></tspan></text>
    ...
    <text id="En_2_heures" data-name="En
2 heures" transform="translate(722 625)" fill="#5c5d5e" font-size="18" font-family="Segoe UI Variable Text" font-weight="600"><tspan x="0" y="0">En</tspan><tspan x="0" y="24">2 heures</tspan></text>
    </g>
    </svg>
   </div>
   <div class="col-6 col-md-3">
    ...
    <text id="_55" data-name="$55" transform="translate(865 596)" fill="#613818" font-size="50" font-family="Segoe UI Variable Text" font-weight="600"><tspan x="0" y="0">$<?= $_SESSION['cout_total_zone'][0]?></tspan></text>
    ...
    <text id="En_Direct" data-name="En
Direct" transform="translate(906 627)" fill="#5c5d5e" font-size="18" font-family="Segoe UI Variable Text" font-weight="600"><tspan x="0" y="0">En</tspan><tspan x="0" y="24">Direct</tspan></text>
    </g>
    </svg>
   </div>
   </div><br>
   <input type="submit" class="submit" name="submit1" value="Poursuivre" onclick="javascript: form.action='form2.php';"/><br><br>
  </form>
